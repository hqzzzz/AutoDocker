...
//基本设置--------------------------------------------------------------------------------------------
$_ENV['key']        =  getenv_docker('SSPANEL_KEY','1ba3eaee62d0Fzgga9riuq');                   
...
$_ENV['appName']    = getenv_docker('SSPANEL_APPNAME','SSPanel-UIM');
$_ENV['baseUrl']    = getenv_docker('SSPANEL_BASEURL','https://www.example.com'); 
$_ENV['muKey']      = getenv_docker('SSPANEL_MUKEY','aee62d0Fzgga9riuq');  

$_ENV['enableAdminApi'] = false;                      // 是否启用 Admin API, 如果不知道此项用途请保持为 false
$_ENV['adminApiToken']  = '3f90d7a4-0dd7-4e2b-abc6-61895f196405';                 // Admin API 的 Token, 请生成为高强度的 Token
//添加主题首页
...
$_ENV['aliyun_accessKey'] = '';   //阿里云key获取地址 https://usercenter.console.aliyun.com/#/manage/ak
$_ENV['aliyun_accessSecret'] = '';
$_ENV['aliyun_endpointName'] = '';    // API 服务器区域名，与区域填写一致
$_ENV['aliyun_RegionId'] = '';    // API 服务器区域
$_ENV['aliyun_Host'] = '';    // API 服务器地址
$_ENV['aliyun_Version'] = '';    // SDK 版本
$_ENV['aliyun_AccountName'] = '';    // 发信地址
...
$_ENV['sub_message'] = [];
$_ENV['disable_sub_mu_port'] = true;                        // 将订阅中单端口的信息去除
...
//支付系统设置----------------------------------------------------------------------------------------
#取值 none | codepay | f2fpay | paymentwall | spay | payjs | yftpay | flyfoxpay
...
#stripe
$_ENV['stripe_currency'] = 'hkd';   // Stripe 支付接口的默认货币，可以写 hkd usd aud等，stripe限制收款货币只能是账号注册地区的货币
$_ENV['stripe_limit'] = 5;        // stripe 限制最低充值金额 0 为默认值
$_ENV['stripe_key'] = '';
$_ENV['stripe_webhook'] = '';

#PcexPay 蜂窝易支付 https://forwe.co/user
...
$_ENV['flag_regex'] = '/(香港|美国|日本|中国|俄罗斯|韩国|英国|新加坡|马来西亚|台湾|加拿大|菲律宾|德国)/';   //从站点全名中匹配【国家/地区】的正则表达式(php版)
